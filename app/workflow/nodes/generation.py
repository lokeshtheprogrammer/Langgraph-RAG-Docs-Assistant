...
from app.workflow.prompts import CONVERSATIONAL_PROMPT, GENERATION_PROMPT, REGEN_PROMPT
    ...
    async def node(state: RAGState) -> dict:
        ...
        try:
            if is_regen:
                ...
                prompt = GENERATION_PROMPT.format(context=context, question=state["question"])
                temperature = 0.2
